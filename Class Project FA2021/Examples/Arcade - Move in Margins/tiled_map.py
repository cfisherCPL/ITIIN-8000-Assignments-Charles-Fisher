...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.player_sprite.center_x = 2440
        self.player_sprite.center_y = 885
    ...
    def load_level(self, level):
        ...
        self.tile_map = arcade.load_tilemap(
            f"/Users/cfisher/Desktop/ITIN 8000 FA2021/ITIN 8000 FA21 - GitHub/ITIIN-8000-Assignments---Charles-Fisher/Class Project FA2021/Examples/Arcade - Move in Margins/32pxUNOmap.json", scaling=TILE_SPRITE_SCALING
        )
        ...
        self.physics_engine = arcade.PhysicsEnginePlatformer(
            self.player_sprite,
            self.tile_map.sprite_lists["Buildings"],
